...
static _PS3 PS3,lastPS3;
static _JKeys JKeys,lastJKeys;
static int bPS3Active,gLeftJoyStickEnable=1,gRightJoyStickEnable=1,robotInStandby,gJoyIMUMixEnable;
...
static void StartPS3Server(void);
...
int SetPS3LEDFlashRate(int rate)
{
	int z;
